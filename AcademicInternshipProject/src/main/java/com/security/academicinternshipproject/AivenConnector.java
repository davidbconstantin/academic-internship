 ...
 * @author rokom
 */
public class AivenConnector {
    public AivenConnector(String host, int port, String databaseName, String userName, String password) throws ClassNotFoundException {
